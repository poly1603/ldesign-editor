 ...
 * 文本转换插件
 */
export const TextTransformPlugin = createPlugin({
    name: 'textTransform',
    commands: {
        toUpperCase,
        toLowerCase,
 ...
 * 大写转换插件（快捷方式）
 */
export const UpperCasePlugin = createPlugin({
    name: 'upperCase',
 ...
 * 小写转换插件（快捷方式）
 */
export const LowerCasePlugin = createPlugin({
    name: 'lowerCase',
 ...
 * 首字母大写插件（快捷方式）
 */
export const CapitalizePlugin = createPlugin({
    name: 'capitalize',
