 ...
 * 颜色选择器 - 基于Modal基类重构
 */
import { hexToRgb, isValidColor, rgbToHex } from '../../utils/color';
...
RecentColorsManager.KEY = 'editor-recent-colors';
RecentColorsManager.MAX_COUNT = 10;
export class ColorPicker extends Modal {
    ...
    createCustomColorSection() {
        ...
        const createRGBInput = (label, key) => {
            ...
            input.addEventListener('input', () => {
                const r = Number.parseInt(this.rgbInputs.r.value) || 0;
                const g = Number.parseInt(this.rgbInputs.g.value) || 0;
                const b = Number.parseInt(this.rgbInputs.b.value) || 0;
