 ...
 * 便捷函数：快速创建轻量级编辑器
 */
export async function createLightweightEditor(element) {
    return createEditor()
        .element(element)
        .lightweight()
        .build();
 ...
 * 便捷函数：快速创建功能完整编辑器
 */
export async function createFullFeaturedEditor(element) {
    return createEditor()
        .element(element)
        .fullFeatured()
        .build();
 ...
 * 便捷函数：快速创建仅格式化编辑器
 */
export async function createFormatOnlyEditor(element) {
    return createEditor()
        .element(element)
        .formatOnly()
        .build();
