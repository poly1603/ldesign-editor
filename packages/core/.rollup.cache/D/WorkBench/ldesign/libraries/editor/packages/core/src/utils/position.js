 ...
 * 调整元素位置以保持在视口内
 */
export function keepInViewport(element, padding = 10) {
 ...
 * 调整位置
 */
export function adjustPosition(el, x, y) {
 ...
 * 获取相对位置
 */
export function getRelativePosition(el, parent) {
 ...
 * 计算最佳弹出位置
 */
export function calculatePopupPosition(trigger, popup, preferredPosition = 'auto', offset = 8) {
