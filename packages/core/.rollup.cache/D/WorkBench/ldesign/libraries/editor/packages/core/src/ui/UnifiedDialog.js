 ...
 * 快捷方法：显示对话框
 */
export function showUnifiedDialog(config) {
 ...
 * 快捷方法：提示对话框
 */
export function showAlertDialog(title, message, onOk) {
    return showUnifiedDialog({
        title,
        content: message,
        buttons: [
 ...
 * 快捷方法：输入对话框
 */
export function showPromptDialog(title, label, onConfirm, options) {
    return showUnifiedDialog({
        title,
        fields: [
            {
