...
const ItalicPlugin = createPlugin({
  name: "italic",
  commands: {
...
const UnderlinePlugin = createPlugin({
  name: "underline",
  commands: {
...
const StrikePlugin = createPlugin({
  name: "strike",
  commands: {
...
const InlineCodePlugin = createPlugin({
  name: "inlineCode",
  commands: {
...
const ClearFormatPlugin = createPlugin({
  name: "clearFormat",
  commands: {
...
export { BoldPlugin, ClearFormatPlugin, CodePlugin, InlineCodePlugin, ItalicPlugin, StrikePlugin, UnderlinePlugin };
