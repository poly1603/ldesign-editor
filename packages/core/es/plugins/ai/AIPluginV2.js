...
import { showAIConfigDialog } from '../../ui/AIConfigDialog.js';
import { showAIDialog, AIMockUtils } from '../../ui/AIDialog.js';
import { getSelectedText, saveRange, replaceSelection } from '../../utils/EditorUtils.js';
...
function createAICommand(type) {
    return (state, dispatch) => {
        ...
        if (type === 'correct' || type === 'rewrite') {
            selectedText = editor.getSelectedText ? editor.getSelectedText() : getSelectedText();
            if (!selectedText) {
        ...
        const dialogHandle = showAIDialog({
            ...
            onConfirm: (text) => {
                ...
                if (editor.contentElement) {
                    ...
                    replaceSelection(text, savedRange);
                    editor.handleInput?.();
                }
            },
        });
...
//# sourceMappingURL=AIPluginV2.js.map
