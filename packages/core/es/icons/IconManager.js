...
import { FeatherIconSet } from './sets/feather.js';
import { LucideIconSet } from './sets/lucide.js';
import { MaterialIconSet } from './sets/material.js';
    ...
    createCustomIconSet() {
        return {
            ...
            searchIcons(query) {
                ...
                return Array.from(this.icons.values()).filter(icon => icon.name.toLowerCase().includes(lowerQuery)
...
export { IconManager, getIconManager, resetIconManager };
