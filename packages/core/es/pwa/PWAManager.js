...
import { InstallPromptManager } from './InstallPromptManager.js';
...
class PWAManager extends EventEmitter {
   ...
   */
  async getStats() {
    const [cacheSize, swStatus] = await Promise.all([this.cacheManager.getSize(), this.swManager.getStatus()]);
    return {
      status: this.status,
...
//# sourceMappingURL=PWAManager.js.map
