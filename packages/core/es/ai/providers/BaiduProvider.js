...
class BaiduProvider {
    ...
    async refreshAccessToken() {
        ...
        const [apiKey, secretKey] = this.config.apiKey.split(':');
        const response = await fetch(`https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&client_id=${apiKey}&client_secret=${secretKey}`, { method: 'POST' });
        if (!response.ok)
...
export { BaiduProvider };
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=BaiduProvider.js.map
