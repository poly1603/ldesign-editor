 ...
 * ***********************************
 */
import { getFeatureFlags, FeatureCategory } from '../core/FeatureFlags.js';
...
class FeatureManagerPanel {
  ...
  createCategorySection(category, features) {
    ...
    `;
    const categoryNames = {
      [FeatureCategory.CORE]: "\u{1F3AF} \u6838\u5FC3\u529F\u80FD",
      [FeatureCategory.FORMAT]: "\u{1F3A8} \u683C\u5F0F\u5316",
      [FeatureCategory.INSERT]: "\u2795 \u63D2\u5165",
      [FeatureCategory.MEDIA]: "\u{1F5BC}\uFE0F \u5A92\u4F53",
      [FeatureCategory.TABLE]: "\u{1F4CA} \u8868\u683C",
      [FeatureCategory.AI]: "\u{1F916} AI",
      [FeatureCategory.TOOL]: "\u{1F527} \u5DE5\u5177",
...
export { FeatureManagerPanel, showFeatureManager };
