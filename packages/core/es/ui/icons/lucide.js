...
const lucideIcons = {
  ...
  "lightbulb": '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 14c.2-1 .7-1.7 1.2-2.4.6-.8 1.2-1.8 1.2-3.1A5.4 5.4 0 0 0 12 3a5.4 5.4 0 0 0-5.4 5.4c0 1.3.6 2.3 1.2 3.1.5.7 1 1.4 1.2 2.4"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>',
  "pen-tool": '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 19 7-7 3 3-7 7-3-3z"/><path d="m18 13-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="m2 2 7.586 7.586"/><circle cx="11" cy="11" r="2"/></svg>',
...
export { getLucideIcon, lucideIcons };
