 ...
 * ***********************************
 */
import { getPluginMarket } from '../marketplace/PluginMarket.js';
import { ui } from '../utils/simplify.js';
import { getComponentFactory } from './base/ComponentFactory.js';
import { Modal } from './base/Modal.js';

class PluginMarketPanel {
  constructor() {
    this.market = getPluginMarket();
  ...
  async installPlugin(pluginId) {
    try {
      ...
      ui.toast(`\u5B89\u88C5\u5931\u8D25\uFF1A${error.message}`, "error");
    }
  }
  /**
   * 卸载插件
  ...
  async uninstallPlugin(pluginId) {
    ...
    try {
      ...
      ui.toast(`\u5378\u8F7D\u5931\u8D25\uFF1A${error.message}`, "error");
    }
  }
  /**
   * 刷新主内容区
...
export { PluginMarketPanel, showPluginMarket };
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=PluginMarketPanel.js.map
