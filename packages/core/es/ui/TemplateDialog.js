 ...
 * ***********************************
 */
import { TemplateCategory } from '../template/types.js';
...
class TemplateDialog {
  ...
  getTemplateIcon(category) {
    const icons = {
      [TemplateCategory.BUSINESS]: "\u{1F4CA}",
      [TemplateCategory.PERSONAL]: "\u{1F464}",
      [TemplateCategory.CREATIVE]: "\u{1F3A8}",
      [TemplateCategory.EDUCATION]: "\u{1F4DA}",
      [TemplateCategory.TECHNICAL]: "\u{1F4BB}",
...
export { TemplateDialog, showTemplateDialog };
