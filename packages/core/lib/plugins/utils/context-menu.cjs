            ...
            const menuItems = [
                ...(hasSelection
                    ? [
                        ...
                        {
                            label: 'Paste',
                            icon: lucide.getLucideIcon('clipboard'),
                            shortcut: 'Ctrl+V',
                            action: () => {
                        ...
                        {
                            label: 'Cut',
                            icon: lucide.getLucideIcon('scissors'),
                            shortcut: 'Ctrl+X',
                            action: () => {
                        ...
                        {
                            label: 'Bold',
                            icon: lucide.getLucideIcon('bold'),
                            shortcut: 'Ctrl+B',
                            action: () => editor.commands.get('bold')?.(),
                        },
                        {
                            label: 'Italic',
                            icon: lucide.getLucideIcon('italic'),
                            shortcut: 'Ctrl+I',
                            action: () => editor.commands.get('italic')?.(),
                        },
                        {
                            label: 'Underline',
                            icon: lucide.getLucideIcon('underline'),
                            shortcut: 'Ctrl+U',
                ...
                {
                    label: 'Select All',
                    icon: lucide.getLucideIcon('selectAll'),
                    shortcut: 'Ctrl+A',
                    action: () => {
                ...
                {
                    label: 'Insert Image',
                    icon: lucide.getLucideIcon('image'),
                    action: () => editor.commands.get('insertImage')?.(),
                },
                {
                    label: 'Insert Link',
                    icon: lucide.getLucideIcon('link'),
                    action: () => editor.commands.get('createLink')?.(),
                },
                {
                    label: 'Insert Table',
                    icon: lucide.getLucideIcon('table'),
