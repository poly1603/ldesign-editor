...
var DiagramRenderer = require('./DiagramRenderer.cjs');
var DiagramToolbar = require('./DiagramToolbar.cjs');
var FlowchartEditor = require('./editors/FlowchartEditor.cjs');
var GanttEditor = require('./editors/GanttEditor.cjs');
var MindMapEditor = require('./editors/MindMapEditor.cjs');
var SequenceDiagramEditor = require('./editors/SequenceDiagramEditor.cjs');
var UMLEditor = require('./editors/UMLEditor.cjs');

/**
 * 图表插件
 * 提供思维导图、流程图、UML图等图表编辑支持
 */
const logger = logger$1.createLogger('DiagramPlugin');
class DiagramPlugin {
    constructor() {
        this.name = 'diagram';
        this.version = '1.0.0';
    ...
    async init(context) {
        ...
        // 初始化渲染器
        this.renderer = new DiagramRenderer.DiagramRenderer({
            editor: context.editor,
        });
        // 初始化工具栏
        this.toolbar = new DiagramToolbar.DiagramToolbar({
            editor: context.editor,
     ...
     */
    registerEditors() {
        this.editors.set('mindmap', new MindMapEditor.MindMapEditor());
        this.editors.set('flowchart', new FlowchartEditor.FlowchartEditor());
        this.editors.set('uml', new UMLEditor.UMLEditor());
        this.editors.set('sequence', new SequenceDiagramEditor.SequenceDiagramEditor());
        this.editors.set('gantt', new GanttEditor.GanttEditor());
    }
    /**
     * 注册命令
     */
...
//# sourceMappingURL=DiagramPlugin.cjs.map
