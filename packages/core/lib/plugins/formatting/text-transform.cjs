 ...
 * 文本转换插件
 */
const TextTransformPlugin = Plugin.createPlugin({
    name: 'textTransform',
    commands: {
        toUpperCase,
        toLowerCase,
 ...
 * 大写转换插件（快捷方式）
 */
const UpperCasePlugin = Plugin.createPlugin({
    name: 'upperCase',
 ...
 * 小写转换插件（快捷方式）
 */
const LowerCasePlugin = Plugin.createPlugin({
    name: 'lowerCase',
 ...
 * 首字母大写插件（快捷方式）
 */
const CapitalizePlugin = Plugin.createPlugin({
    name: 'capitalize',
...
exports.CapitalizePlugin = CapitalizePlugin;
exports.LowerCasePlugin = LowerCasePlugin;
exports.TextTransformPlugin = TextTransformPlugin;
exports.UpperCasePlugin = UpperCasePlugin;
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=text-transform.cjs.map
