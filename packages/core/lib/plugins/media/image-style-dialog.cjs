...
class ImageStyleDialogPlugin extends Plugin.Plugin {
  constructor(options = {}) {
    super();
  ...
  createHeader() {
    ...
    closeBtn.innerHTML = lucide.getLucideIcon("x");
  ...
  createSizeInput() {
    ...
    lockBtn.innerHTML = lucide.getLucideIcon("lock");
    lockBtn.title = "\u9501\u5B9A\u6BD4\u4F8B";
  ...
  createAlignButtons() {
    ...
    alignOptions.forEach((option) => {
      ...
      btn.innerHTML = lucide.getLucideIcon(option.icon);
...
exports.ImageStyleDialogPlugin = ImageStyleDialogPlugin;
exports.default = ImageStyleDialogPlugin;
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=image-style-dialog.cjs.map
