 ...
 * 识别和处理各种触摸手势
 */
logger.createLogger('GestureRecognizer');
class GestureRecognizer extends event.EventEmitter {
    ...
    handleTouchStart(e) {
        ...
        if (e.touches.length === 1) {
            ...
            this.longPressTimer = window.setTimeout(() => {
                ...
                if (touchInfo) {
                    const moveDistance = Math.sqrt((touchInfo.currentX - touchInfo.startX) ** 2
...
//# sourceMappingURL=GestureRecognizer.cjs.map
