 ...
 * 提供高性能的文本差异计算
 */
const logger = logger$1.createLogger('WasmDiff');
...
class WasmDiff {
    ...
    async loadWasmBytes() {
        ...
        // 生产环境：使用内联的Base64
        // 注意：实际项目中应该构建时生成
        const base64 = await Promise.resolve().then(function () { return require('./diff.wasm.base64.cjs'); });
...
exports.WasmDiff = WasmDiff;
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=WasmDiff.cjs.map
