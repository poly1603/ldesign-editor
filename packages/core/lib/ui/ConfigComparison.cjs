...
class ConfigComparison {
    ...
    createSelectors() {
      ...
      align-items: center;
    `;
        const presetNames = index.getPresetNames();
        const options = presetNames.map(name => ({
            label: `${index.presetDescriptions[name].icon} ${index.presetDescriptions[name].name}`,
            value: name,
        }));
    ...
    compare(preset1, preset2) {
        const config1 = index.getPreset(preset1);
        const config2 = index.getPreset(preset2);
        // 对比功能
    ...
    renderComparison(comparison) {
        ...
        if (!resultArea)
            return;
        const desc1 = index.presetDescriptions[comparison.preset1];
        const desc2 = index.presetDescriptions[comparison.preset2];
...
exports.ConfigComparison = ConfigComparison;
exports.showConfigComparison = showConfigComparison;
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=ConfigComparison.cjs.map
