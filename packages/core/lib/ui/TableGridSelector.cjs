...
function showTableGridSelector(options) {
    const { onSelect, maxRows = 10, maxCols = 10, button, } = options;
    // 创建自定义内容容器
...
exports.showEnhancedTableGridSelector = showEnhancedTableGridSelector;
exports.showTableGridSelector = showTableGridSelector;
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=TableGridSelector.cjs.map
