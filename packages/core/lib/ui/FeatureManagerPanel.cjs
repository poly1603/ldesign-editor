...
class FeatureManagerPanel {
    ...
    `;
        const categoryNames = {
            [FeatureFlags.FeatureCategory.CORE]: '🎯 核心功能',
            [FeatureFlags.FeatureCategory.FORMAT]: '🎨 格式化',
            [FeatureFlags.FeatureCategory.INSERT]: '➕ 插入',
            [FeatureFlags.FeatureCategory.MEDIA]: '🖼️ 媒体',
            [FeatureFlags.FeatureCategory.TABLE]: '📊 表格',
            [FeatureFlags.FeatureCategory.AI]: '🤖 AI',
            [FeatureFlags.FeatureCategory.TOOL]: '🔧 工具',
