...
class LucideIconSet {
    ...
    loadIcons() {
        const iconDefinitions = [
            ...
            // 历史操作
            {
                ...
                category: types.IconCategory.ACTION,
            ...
            // 表情和特殊符号
            {
                ...
                category: types.IconCategory.OTHER,
            ...
            // 文件和模板
            {
                ...
                category: types.IconCategory.FILE,
            ...
            // 箭头
            {
                ...
                category: types.IconCategory.ARROW,
                tags: ['arrow', 'up'],
            },
            {
                name: 'arrow-down',
    ...
    searchIcons(query) {
        ...
        return this.getAllIcons().filter(icon => icon.name.toLowerCase().includes(lowerQuery)
            || icon.tags?.some(tag => tag.toLowerCase().includes(lowerQuery)));
    }
}

exports.LucideIconSet = LucideIconSet;
