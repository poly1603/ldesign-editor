  ...
  async getAll() {
    try {
      ...
      return templates.map((t) => ({
        ...
        metadata: {
          ...t.metadata,
          createdAt: t.metadata.createdAt ? new Date(t.metadata.createdAt) : void 0,
          updatedAt: t.metadata.updatedAt ? new Date(t.metadata.updatedAt) : void 0
        }
      }));
    } catch (error) {
...
exports.LocalTemplateStorage = LocalTemplateStorage;
/*! End of @ldesign/editor-core | Powered by @ldesign/builder */
//# sourceMappingURL=LocalTemplateStorage.cjs.map
